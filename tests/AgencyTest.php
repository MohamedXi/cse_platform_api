...
class AgencyTest extends ApiTestCase
{
    ...
    public function testGetCollection(): void
    {
        ...
        $response = static::createClient([], ['headers' => ['authorization' => 'Bearer '.self::TOKEN]])->request('GET', 'api/agencies');
        ...
        $this->assertMatchesResourceCollectionJsonSchema(Agency::class);
    }
}
