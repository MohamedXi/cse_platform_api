...
class RentalTest extends ApiTestCase
{
    ...
    public function testGetCollection(): void
    {
        ...
        $response = static::createClient([], ['headers' => ['authorization' => 'Bearer '.self::TOKEN]])->request('GET', 'api/rentals');
        ...
        $this->assertMatchesResourceCollectionJsonSchema(Rental::class);
    }
}
