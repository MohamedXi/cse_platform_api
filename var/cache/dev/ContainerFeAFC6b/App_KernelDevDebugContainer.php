...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CheckHealthController' => 'getCheckHealthControllerService',
            'App\\Controller\\CreateImageController' => 'getCreateImageControllerService',
            'App\\Controller\\CreateRentalController' => 'getCreateRentalControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\UniqidNamer.image' => 'getUniqidNamer_ImageService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\ItemTypeRepository' => ['privates', 'App\\Repository\\ItemTypeRepository', 'getItemTypeRepositoryService', true],
            'App\\Repository\\RentalRepository' => ['privates', 'App\\Repository\\RentalRepository', 'getRentalRepositoryService', true],
            ...
            'App\\Repository\\ItemTypeRepository' => '?',
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_item_api_platform_core_bridge_doctrine_orm_filter_date_filter' => ['privates', 'annotated_app_entity_item_api_platform_core_bridge_doctrine_orm_filter_date_filter', 'getAnnotatedAppEntityItemApiPlatformCoreBridgeDoctrineOrmFilterDateFilterService', true],
            'annotated_app_entity_item_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_item_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityItemApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_rental_api_platform_core_bridge_doctrine_orm_filter_date_filter' => ['privates', 'annotated_app_entity_rental_api_platform_core_bridge_doctrine_orm_filter_date_filter', 'getAnnotatedAppEntityRentalApiPlatformCoreBridgeDoctrineOrmFilterDateFilterService', true],
            ...
            'annotated_app_entity_item_api_platform_core_bridge_doctrine_orm_filter_date_filter' => '?',
            'annotated_app_entity_item_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_rental_api_platform_core_bridge_doctrine_orm_filter_date_filter' => '?',
    ...
    protected function getApiPlatform_Identifier_ConverterService()
    {
        return $this->privates['api_platform.identifier.converter'] = new \ApiPlatform\Core\Identifier\IdentifierConverter(($this->privates['api_platform.identifiers_extractor.cached'] ?? $this->getApiPlatform_IdentifiersExtractor_CachedService()), ($this->privates['api_platform.metadata.property.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Property_MetadataFactory_CachedService()), new RewindableGenerator(function () {
            ...
            yield 4 => ($this->privates['api_platform.identifier.uuid_normalizer'] ?? ($this->privates['api_platform.identifier.uuid_normalizer'] = new \ApiPlatform\Core\Bridge\RamseyUuid\Identifier\Normalizer\UuidNormalizer()));
        }, 5));
    }
    ...
    protected function getDebug_ApiPlatform_CollectionDataProviderService()
    {
        return $this->privates['debug.api_platform.collection_data_provider'] = new \ApiPlatform\Core\Bridge\Symfony\Bundle\DataProvider\TraceableChainCollectionDataProvider(new \ApiPlatform\Core\DataProvider\ChainCollectionDataProvider(new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\DataProvider\\RentalDataProvider'] ?? $this->load('getRentalDataProviderService'));
            yield 1 => ($this->privates['App\\DataProvider\\ItemDataProvider'] ?? $this->load('getItemDataProviderService'));
            yield 2 => ($this->privates['api_platform.doctrine.orm.default.collection_data_provider'] ?? $this->load('getApiPlatform_Doctrine_Orm_Default_CollectionDataProviderService'));
        }, 3)));
    }
    ...
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.JYo.9Ts'] ?? $this->get_ServiceLocator_JYo_9TsService()), new RewindableGenerator(function () {
            yield 'security.firewall.map.context.dev' => ($this->privates['.security.request_matcher.OhmCH_5'] ?? ($this->privates['.security.request_matcher.OhmCH_5'] = new \Symfony\Component\HttpFoundation\RequestMatcher('(^/api/docs)|^/(_(profiler|wdt)|css|images|js)/')));
            yield 'security.firewall.map.context.api' => ($this->privates['.security.request_matcher.StwF68u'] ?? ($this->privates['.security.request_matcher.StwF68u'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(profile|api/.*)')));
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'kid': $value = $this->getEnv('KID'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.title' => 'CSE Platform',
