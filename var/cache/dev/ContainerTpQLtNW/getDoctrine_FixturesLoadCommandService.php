...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/AgencyFixtures.php';
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ItemFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ItemTypeFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AgencyFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ItemFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\ItemTypeFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\TagFixtures(), 'groups' => []]]);
