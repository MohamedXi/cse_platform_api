 ...
 */
class getAnnotatedAppEntityRentalApiPlatformCoreBridgeDoctrineOrmFilterDateFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'annotated_app_entity_rental_api_platform_core_bridge_doctrine_orm_filter_date_filter' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotated_app_entity_rental_api_platform_core_bridge_doctrine_orm_filter_date_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\DateFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), NULL, ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()), ['dueDate' => 'include_null_after', 'startDate' => 'include_null_after', 'endDate' => 'include_null_after'], ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()));
    }
}
